...
//' @export
// [[Rcpp::export]]
void writeSdpaFormatFile(Rcpp::Reference spectrahedron = R_NilValue,
    ...
    std::vector<MT> matrices = Rcpp::as<std::vector<MT> > (Rcpp::as<Rcpp::Reference> (spectrahedron).slot("matrices"));
    LMI lmi(matrices);
